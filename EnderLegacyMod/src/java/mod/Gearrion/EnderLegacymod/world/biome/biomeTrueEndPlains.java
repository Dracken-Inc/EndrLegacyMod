...
public class biomeTrueEndPlains extends BiomeGenBase{
	
		//public static final int treesPerChunk = 0;
		

		@SuppressWarnings("unchecked")
		public biomeTrueEndPlains(int id){
		super(id);
			...
			for (int y = 255; y >= 0; --y) {
				...
				if (y <= random.nextInt(5)) {
					...
					if (existingBlock != null && existingBlock.getMaterial() != Material.air) {
						if (existingBlock == Blocks.sandstone) {
