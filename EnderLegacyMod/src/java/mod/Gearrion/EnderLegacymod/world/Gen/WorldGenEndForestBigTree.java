...
public class WorldGenEndForestBigTree extends WorldGenForestAbstractTree
{
	private static Block log = ModBlocks.EnderLog;
	private static Block leaves = ModBlocks.End_Leaves;
	...
	public WorldGenEndForestBigTree(boolean p_i2008_1_, int treeHeight, int trunkWidth, int leavesWidthFromBase)
	{
		super(p_i2008_1_);
	...
	boolean validTreeLocation()
	{
		...
		if (block == Blocks.end_stone || block == Blocks.end_stone) {
			isSoil = true;
		}
