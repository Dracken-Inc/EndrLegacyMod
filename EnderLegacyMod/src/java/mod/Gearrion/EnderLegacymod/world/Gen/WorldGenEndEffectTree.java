...
public class WorldGenEndEffectTree extends WorldGenForestAbstractTree
{
	private Block log = ModBlocks.EnderLog;
	private Block leaves = ModBlocks.End_Effect_Leaves;
	
    @SuppressWarnings("unused")
	private static final String __OBFID = "CL_00000432";

    public WorldGenEndEffectTree(boolean p_i45463_1_) {
        super(p_i45463_1_);
    }
