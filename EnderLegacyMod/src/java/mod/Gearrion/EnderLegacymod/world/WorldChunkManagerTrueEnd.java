...
public class WorldChunkManagerTrueEnd extends WorldChunkManager {
    ...
    public WorldChunkManagerTrueEnd(long p_i1975_1_, WorldType p_i1975_3_)
    {
        this();
        GenLayer[] agenlayer = EndForestGenLayer.makeTheWorld(p_i1975_1_, p_i1975_3_);
        agenlayer = getModdedBiomeGenerators(p_i1975_3_, p_i1975_1_, agenlayer);
        this.genBiomes = agenlayer[0];
        this.biomeIndexLayer = agenlayer[1];
    }

    public WorldChunkManagerTrueEnd(World p_i1976_1_)
    {
     ...
     */
    public boolean areBiomesViable(int p_76940_1_, int p_76940_2_, int p_76940_3_, @SuppressWarnings("rawtypes") List p_76940_4_)
    {
        IntCache.resetIntCache();
    ...
    public ChunkPosition findBiomePosition(int p_150795_1_, int p_150795_2_, int p_150795_3_, @SuppressWarnings("rawtypes") List p_150795_4_, Random p_150795_5_)
    {
        IntCache.resetIntCache();
