...
import mod.Gearrion.EnderLegacymod.Util.GameLogHelper;
...
public class ChunkProviderTrueEnd implements IChunkProvider {
	...
	public ChunkProviderTrueEnd(World world, long seed, boolean mapFeaturesEnabled)
	{
	...
	public void ChunkProviderTrueEnd1(World worldObj2, long seed, boolean mapFeaturesEnabled2) {
					...
					for (int l2 = 0; l2 < 8; ++l2) {
						...
						for (int i3 = 0; i3 < 4; ++i3) {
							...
							for (int k3 = 0; k3 < 4; ++k3) {
								if ((d15 += d16) > 0.0D) {
									blocks[j3 += short1] = Blocks.end_stone;//these can be set to custom blocks
								} else if (k2 * 8 + l2 < b0) {
