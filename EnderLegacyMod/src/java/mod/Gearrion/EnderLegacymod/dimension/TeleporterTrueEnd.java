...
public class TeleporterTrueEnd extends Teleporter {
	...
	public TeleporterTrueEnd(WorldServer worldserver) {
		super(worldserver);
	...
	public boolean placeInExistingPortal(Entity entity, double par2, double par4, double par6, float par8){
		...
		if(this.destinationCoordinateCache.containsItem(j1)){
			TeleporterTrueEnd.PortalPosition portalposition = (Teleporter.PortalPosition)this.destinationCoordinateCache.getValueByKey(j1);
			d3 = 0.0D;
