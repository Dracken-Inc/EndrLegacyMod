...
import mod.Gearrion.EnderLegacymod.world.dimension.TeleporterTrueEnd;
...
public class TrueEndPortal extends BlockBreakable
{
	...
	{
		super("EnderLegacyMod:" + name, Material.portal, false);
	...
	public static class Size
	{
		...
		protected int func_150853_a(int x, int y, int z, int p_150853_4_)
		{
			...
			for (i1 = 0; i1 < 22; ++i1)
			{
				...
				if (block1 != ModBlocks.Endersteelblock)
				{
					break;
				}
			}
			...
			block = this.worldObj.getBlock(x + j1 * i1, y, z + k1 * i1);
			return block == ModBlocks.Endersteelblock ? i1 : 0;
		}
		...
		protected int func_150858_a()
		{
			...
			label56:
				...
				for (this.field_150862_g = 0; this.field_150862_g < 21; ++this.field_150862_g)
				{
					...
					for (j = 0; j < this.field_150868_h; ++j)
					{
						...
						if (block == ModBlocks.TrueEndPortal)
						{
							++this.field_150864_e;
						}
						...
						if (j == 0)
						{
							...
							if (block != ModBlocks.Endersteelblock)
							{
								break label56;
							}
						}
			...
			for (i = 0; i < this.field_150868_h; ++i)
			{
				...
				if (this.worldObj.getBlock(j, k, l) != ModBlocks.Endersteelblock)
				{
