...
import mod.Gearrion.EnderLegacymod.util.TrueEndTeleporter;
...
public class TrueEndPortal extends BlockBreakable
{
	public static final int[][] field_150001_a = new int[][] {new int[0], {3, 1}, {2, 0}};
	@SuppressWarnings("unused")
	private static final String __OBFID = "CL_00000284";

	public TrueEndPortal(String name)
	{
	...
	public boolean getPortalSize(World world, int x, int y, int z) {
		TrueEndPortal.Size size = new TrueEndPortal.Size(world, x, y, z, 1);
		TrueEndPortal.Size size1 = new TrueEndPortal.Size(world, x, y, z, 2);
	...
	public void onEntityCollidedWithBlock(World world, int x, int y, int z, Entity entity) {
		if ((entity.ridingEntity == null) && (entity.riddenByEntity == null) && ((entity instanceof EntityPlayerMP))) {
			...
			} else if (thePlayer.dimension != mod.Gearrion.EnderLegacymod.world.DimensionIDs.TrueEnd) {
				thePlayer.timeUntilPortal = 10;
				thePlayer.mcServer.getConfigurationManager().transferPlayerToDimension(thePlayer, mod.Gearrion.EnderLegacymod.world.DimensionIDs.TrueEnd, new TrueEndTeleporter(thePlayer.mcServer.worldServerForDimension(mod.Gearrion.EnderLegacymod.world.DimensionIDs.TrueEnd)));
			} else {
				thePlayer.timeUntilPortal = 10;
				thePlayer.mcServer.getConfigurationManager().transferPlayerToDimension(thePlayer, 0, new TrueEndTeleporter(thePlayer.mcServer.worldServerForDimension(0)));
			}
		}
	}
	...
	public static class Size
	{
		...
		public Size(World p_i45415_1_, int p_i45415_2_, int p_i45415_3_, int p_i45415_4_, int p_i45415_5_)
		{
			...
			this.field_150863_d = TrueEndPortal.field_150001_a[p_i45415_5_][0];
			this.field_150866_c = TrueEndPortal.field_150001_a[p_i45415_5_][1];
		...
		protected int func_150858_a()
		{
			...
			label56:
				...
				for (this.field_150862_g = 0; this.field_150862_g < 21; ++this.field_150862_g)
				{
					...
					{
						k = this.field_150861_f.posX + j * Direction.offsetX[TrueEndPortal.field_150001_a[this.field_150865_b][1]];
						l = this.field_150861_f.posZ + j * Direction.offsetZ[TrueEndPortal.field_150001_a[this.field_150865_b][1]];
						...
						if (block == ModBlocks.Enderstonebricks)
						{
							++this.field_150864_e;
						}
						...
						if (j == 0)
						{
							block = this.worldObj.getBlock(k + Direction.offsetX[TrueEndPortal.field_150001_a[this.field_150865_b][0]], i, l + Direction.offsetZ[TrueEndPortal.field_150001_a[this.field_150865_b][0]]);
						...
						{
							block = this.worldObj.getBlock(k + Direction.offsetX[TrueEndPortal.field_150001_a[this.field_150865_b][1]], i, l + Direction.offsetZ[TrueEndPortal.field_150001_a[this.field_150865_b][1]]);
			...
			{
				j = this.field_150861_f.posX + i * Direction.offsetX[TrueEndPortal.field_150001_a[this.field_150865_b][1]];
				k = this.field_150861_f.posY + this.field_150862_g;
				l = this.field_150861_f.posZ + i * Direction.offsetZ[TrueEndPortal.field_150001_a[this.field_150865_b][1]];
		...
		protected boolean getBlockMaterial(Block block){
			return block.getMaterial() == Material.air || block == ModBlocks.lightFire || block == ModBlocks.TrueEndPortal;
		}
		...
		public void func_150859_c()
		{
			for (int i = 0; i < this.field_150868_h; ++i)
			{
				...
				for (int l = 0; l < this.field_150862_g; ++l)
				{
					...
					this.worldObj.setBlock(j, i1, k, ModBlocks.TrueEndPortal, this.field_150865_b, 2);
				}
			}
		}
	}
